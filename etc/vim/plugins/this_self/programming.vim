...
autocmd FileType python map <buffer> <F9> :exec '!python' shellescape(@%, 1)<cr>
" Same as above, but letting user enter any arguments before executing
autocmd FileType python map <F10> :exec '!python' shellescape(@%, 1) 'args'
autocmd FileType python nmap <leader>gr :w <bar> exec '!python' shellescape(@%, 1) 'args'
